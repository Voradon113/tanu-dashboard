...
const CFG = {
  CONTRACT   : 'GCV6',         // ⚠️ จุดเดียวที่กำหนดสัญญา — ตอนม้วนสัญญาแก้ตรงนี้ที่เดียว
                               //    ต.ค. 2026 = underlying ของออปชั่นทองตอนนี้ (ยืนยันจาก CME)
                               //    basis กับ CFD ~32.7 ไม่ใช่ 26.5 ของสัญญาเดิม
